...
@Component({
  ...
  <div class="bg-primary-reverse h-screen w-screen flex flex-column align-items-center justify-content-center">
    ...
    <h3 class="line-height-3 font-bold">Por favor verifique que la ruta o sus credenciales de acceso sean correctos</h3>
    <p-button type="button" routerLink="/dashboard/welcome" styleClass=" p-button-raised" >Regresar a la página de inicio</p-button>
  </div>
  `,
  styles: [
  ]
